...
function loadPhase2() {
  ...
  gameWindow.innerHTML = `
    ...
    <p style="color: #94a3b8; font-size: 0.95rem; padding: 0 20px;">
...
// --- PHASE 3: The Logic Matrix (Hidden Mercy Protocol) ---
function loadPhase3() {
  gameWindow.innerHTML = `
    <h3 style="margin-bottom: 12px;">Final Security Check</h3>
    <p style="color: #94a3b8; font-size: 0.95rem;">Uncheck all boxes below to finalize your request.</p>
  ...
  function renderGrid() {
    ...
    for (let i = 0; i < 9; i++) {
      ...
      cb.addEventListener('click', (e) => {
        ...
        // Silent mercy override: clears the grid invisibly on the 13th interaction
        if (clickCount >= maxClicks && !allUnchecked) {
...
function showVictory() {
  gameWindow.innerHTML = `
    ...
    <p style="color: #94a3b8;">You have defeated the corporate labyrinth.</p>
    <p style="margin-top: 30px; font-size: 0.75rem; color: #64748b;">*By reading this sentence, you have automatically signed a 10-year lease for a timeshare in Florida.</p>
  `;
}
